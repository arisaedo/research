...
**وافل (Waffle)** _یک چارچوب کاری برای توسعه و تست قرارداد هوشمند پیشرفته (بر پایه ethers.js)._
...
**DappUniversity** _آموزش ساخت برنامه‌های کاربردی غیرمتمرکز روی بلاک‌چین اتریوم_
